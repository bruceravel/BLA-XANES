...
animated gif file will be written.  For ~herfd~ or ~rixs~, it shows
the steps from elastic image to final mask.  For ~map~, it shows the
motion of the map across the face of the detector.
